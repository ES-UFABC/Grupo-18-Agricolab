...
public class ProdutorProcessor {
    ...
    public Produtor createProdutor(Produtor produtor){
        final ProdutorEntity produtorEntity = ProdutorEntityMapper.INSTANCE.produtorToEntity(produtor);
    ...
    public Produtor modificaProdutor(Produtor produtorRequest, int id){
        ...
        final ProdutorEntity produtorEntity = produtorRepository.findByIdProdutor(id);
        ...
        final ProdutorEntity produtorEntityNovo = ProdutorEntityMapper.INSTANCE.produtorToEntity(produtor);
